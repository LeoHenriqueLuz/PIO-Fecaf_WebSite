...
// Mudar Aqui o e-mail
$email_envio = "contato@Lavtech.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "lavtech12"; // Senha do e-mail

$site_name = "Lavtech"; // Nome do Site
$site_url = "www.lavtech.com"; // URL do Site
